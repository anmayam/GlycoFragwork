...
#filename1 <- "D:\\data\\GlycoFragwork\\ForPaper\\FetuinMap\\Map\\fetuin_hcd_cid_etd_mln_map_glycopeptides_Test6.csv";
#filenameout <- "D:\\data\\GlycoFragwork\\ForPaper\\FetuinMap\\Map\\fetuin_hcd_cid_etd_mln_mln_map_glycopeptides_Test6_LDA.csv" ; 

#filename1 <- "D:\\data\\GlycoFragwork\\ForPaper\\FetuinMap\\Map\\fetuin_hcd_cid_etd_mln_map_glycopeptides_Test.csv";
#filenameout <- "D:\\data\\GlycoFragwork\\ForPaper\\FetuinMap\\Map\\fetuin_hcd_cid_etd_mln_mln_map_glycopeptides_Test_LDA.csv" ; 

#filename1 <- "D:\\data\\GlycoFragwork\\ForPaper\\CombinedMixtureMap\\Map1\\Map\\5sg_hcd_cid_etd_mln_map_glycopeptides_CombinedETD3.csv" ; 
#filenameout <- "D:\\data\\GlycoFragwork\\ForPaper\\CombinedMixtureMap\\Map1\\Map\\5sg_hcd_cid_etd_mln_map_glycopeptides_CombinedETD3_LDA.csv" ; 

#filename1 <- "D:\\data\\GlycoFragwork\\ForPaper\\CombinedMixtureMap\\Map1\\Map\\5sg_hcd_cid_etd_mln_map_glycopeptides_Test4.csv" ; 
#filenameout <- "D:\\data\\GlycoFragwork\\ForPaper\\CombinedMixtureMap\\Map1\\Map\\5sg_hcd_cid_etd_mln_map_glycopeptides_Test4_LDA.csv" ; 

#filename1 <- "D:\\data\\GlycoFragwork\\ForPaper\\SerumMap\\Map\\serum_mln_map_glycopeptides_BigDB3.csv" ; 
#filenameout <- "D:\\data\\GlycoFragwork\\ForPaper\\SerumMap\\Map\\serum_mln_map_glycopeptides_BigDB3_LDA.csv" ; 

filename1 <- "D:\\data\\GlycoMapQuant\\ForPaper\\Fetuin_HILIC\\MAP\\Map2\\fetuin_hilic_cmd_map_map_glycopeptides.csv" ; 
filenameout <- "D:\\data\\GlycoMapQuant\\ForPaper\\Fetuin_HILIC\\MAP\\Map2\\fetuin_hilic_cmd_map_map_glycopeptides_LDA.csv" ; 
