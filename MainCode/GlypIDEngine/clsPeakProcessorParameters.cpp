...
namespace GlypID
{
	namespace Peaks
	{
		...
		void clsPeakProcessorParameters::SavePeakParameters(System::Xml::XmlTextWriter *xwriter)
		{
		...
		void clsPeakProcessorParameters::LoadPeakParameters(XmlReader *rdr)
		{
				...
				switch (rdr->NodeType)
				{
					case XmlNodeType::Element:
						...
						else if (rdr->Name->Equals(S"PeakFitType"))
						{
							...
							if (rdr->Value->Equals(__box(GlypID::Peaks::PEAK_FIT_TYPE::QUADRATIC)->ToString()))
							{
								this->PeakFitType = GlypID::Peaks::PEAK_FIT_TYPE::QUADRATIC ;
							}
							else if (rdr->Value->Equals(__box(GlypID::Peaks::PEAK_FIT_TYPE::LORENTZIAN)->ToString()))
							{
								this->PeakFitType = GlypID::Peaks::PEAK_FIT_TYPE::LORENTZIAN ;
							}
							else if (rdr->Value->Equals(__box(GlypID::Peaks::PEAK_FIT_TYPE::APEX)->ToString()))
							{
								this->PeakFitType = GlypID::Peaks::PEAK_FIT_TYPE::APEX ;
							}
						}
						break ; 
