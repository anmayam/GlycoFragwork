	...
	namespace Writers
	{
		...
		*/
		...
		public:
			...
			*/
			inline int LookLeft(std::vector<Engine::Writers::LCMSPeak<PeakClass> > &vec, double mz_val, int start_index)
			{
			...
			/*!
				...
				\return returns the index of the point that is closest to the specified value. 
			*/
			inline int LookRight(std::vector<Engine::Writers::LCMSPeak<PeakClass> > &vec, double mz_val, int start_index)
			{
			...
			/*!
				...
				\return returns the index of the point that is closest to the specified value. 
			*/
			inline int GetNearestBinary(std::vector<Engine::Writers::LCMSPeak<PeakClass> > &vec, 
