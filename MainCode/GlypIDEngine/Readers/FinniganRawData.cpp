...
namespace Engine 
{
	namespace Readers
	{
		...
		bool FinniganRawData::IsSIDScan(int scan_num)
		{
			char ch_filter [512] ; 					
			_bstr_t bstr_filter ;
			bool sid  = false ; 
			...
			//if (_strnicmp(ch_filter, "sid=", 1)== 0)
			if(strstr(ch_filter, "sid") != NULL) 
			{
				sid = true; 
			}
			else
		...
		bool FinniganRawData::IsHCDScan(int scan_num)
		{
			bool ishcd = false ; 
			char ch_filter [512] ; 					
			_bstr_t bstr_filter ;
		...
		bool FinniganRawData::IsETDScan(int scan_num)
		{
			bool isetd = false ; 
			char ch_filter [512] ; 
			_bstr_t bstr_filter ;
		...
		bool FinniganRawData::IsCIDScan(int scan_num)
		{
			bool iscid = false ; 
			char ch_filter [512] ; 
			_bstr_t bstr_filter ;
		...
		double FinniganRawData::GetLevelNParentMz(int scan_num, int level_n)
		{
