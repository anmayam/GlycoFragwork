...
namespace GlypID
{
	...
	{
		mobjAtomicInfo = new Engine::HornTransformTheoreticalProfile::AtomicInformation() ;
	}
	...
	{
		Engine::HornTransformTheoreticalProfile::ElementalIsotopes element_isotopes = mobjAtomicInfo->mvect_elemental_isotopes[index];	
		...
		double __gc &isotope_prob) 
	{
		...
		GlypID::Utils::GetStr(element_name, element_isotopes.marr_name);
		GlypID::Utils::GetStr(element_symbol, element_isotopes.marr_symbol);
	...
	void clsElementIsotopes::SetElementalIsotopeComposition(Engine::HornTransformTheoreticalProfile::AtomicInformation 
	__nogc *atomic_info)
	{
		if (mobjAtomicInfo != NULL)
		{
	...
	const Engine::HornTransformTheoreticalProfile::AtomicInformation* clsElementIsotopes::GetElementalIsotopeComposition()
	{
		return mobjAtomicInfo ; 
	}

	void clsElementIsotopes::SaveElementIsotopes(System::Xml::XmlTextWriter *xwriter)
	{
	...
	void clsElementIsotopes::LoadElementIsotopes(System::Xml::XmlReader *rdr)
	{
