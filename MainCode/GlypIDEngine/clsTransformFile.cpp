...
namespace GlypID
{
	...
	void clsTransformFile::ReadFile(System::String *file_name, GlypID::Results::clsTransformResults *results, 
	...
	void clsTransformFile::WritePeaks(std::fstream &fout, GlypID::Results::clsTransformResults *results)
	{
		const int PK_SIZE = sizeof(Engine::Writers::LCMSPeak<Engine::Writers::PeakMinInfo>) ; 
		...
		{
			*((Engine::Writers::LCMSPeak<Engine::Writers::PeakMinInfo> *)&peaks[pk_num])
	...
	void clsTransformFile::WriteFile(System::String *file_name, GlypID::Results::clsTransformResults *results, 
		Peaks::clsPeakProcessorParameters *peak_parameters, HornTransform::clsHornTransformParameters *transform_parameters)
	{
	...
	void clsTransformFile::WriteFile(char *file_name, GlypID::Results::clsTransformResults *results, 
		Peaks::clsPeakProcessorParameters *peak_parameters, HornTransform::clsHornTransformParameters *transform_parameters)
	{
