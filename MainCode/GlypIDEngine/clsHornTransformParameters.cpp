...
namespace GlypID
{
	namespace HornTransform
	{
		clsHornTransformParameters::clsHornTransformParameters(void)
		{
			...
			mobjElementIsotopes = new GlypID::clsElementIsotopes() ; 
			...
			mshort_sg_right = 2  ;
			mshort_sg_order = 2  ;
			menmFitType = GlypID::enmIsotopeFitType::AREA ;
		...
		void clsHornTransformParameters::SaveHornTransformParameters(System::Xml::XmlTextWriter *xwriter)
		{
		...
		void clsHornTransformParameters::SaveMiscellaneousParameters(System::Xml::XmlTextWriter *xwriter)
		{
		...
		void clsHornTransformParameters::LoadHornTransformParameters(XmlReader *rdr)
		{
				...
				switch (rdr->NodeType)
				{
					case XmlNodeType::Element:
						...
						else if (rdr->Name->Equals(S"IsotopeFitType"))
						{
							...
							if (rdr->Value->Equals(__box(GlypID::enmIsotopeFitType::AREA)->ToString()))
							{
								this->IsotopeFitType = GlypID::enmIsotopeFitType::AREA ;
							}
							else if (rdr->Value->Equals(__box(GlypID::enmIsotopeFitType::PEAK)->ToString()))
							{
								this->IsotopeFitType = GlypID::enmIsotopeFitType::PEAK ;
							}
							else if (rdr->Value->Equals(__box(GlypID::enmIsotopeFitType::CHISQ)->ToString()))
							{
								this->IsotopeFitType = GlypID::enmIsotopeFitType::CHISQ ;
							}
						}
						break ; 
		...
		void clsHornTransformParameters::LoadMiscellaneousParameters(XmlReader *rdr)
		{
