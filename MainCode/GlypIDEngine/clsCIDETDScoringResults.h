...
namespace GlypID
{
	namespace Results
	{
		public __gc class clsCIDETDCombinedScoringResults
		{
			int mint_percent_done ; 
			GlypID::Readers::FileType menmFileType ; 
		public:
			Engine::Writers::CIDETDCombinedScoringResults __nogc *mobj_cid_etd_combined_scoring_results ;			
			void SetCombinedScoringResults(Engine::Writers::CIDETDCombinedScoringResults *results) ; 			
			void WriteResults(System::String *fileName) ; 
			void ReadResults(System::String *fileName) ; 
			clsCIDETDCombinedScoringResults(void);
			~clsCIDETDCombinedScoringResults(void);		
