...
#include "../HornTransformTheoreticalProfile/Averagine.h"
...
namespace Engine	
{
	...
	{	
		...
		*/
		...
		protected:
			...
			HornTransformTheoreticalProfile::MolecularFormula mobj_empirical_formula ; 
	...
	#pragma warning(default:4251)
			...
			*/
			...
			HornTransformTheoreticalProfile::Averagine mobj_averagine ; 
		...
		public:
			...
			HornTransformTheoreticalProfile::MercuryIsotopeDistribution mobj_isotope_dist ; 
			//! default constructor.
			IsotopeFit(void);
			//! destructor.
			~IsotopeFit(void);
			...
			*/
			void SetElementalIsotopeComposition(const HornTransformTheoreticalProfile::AtomicInformation &iso_comp) ; 
			void GetElementalIsotopeComposition(HornTransformTheoreticalProfile::AtomicInformation &iso_comp) ; 
