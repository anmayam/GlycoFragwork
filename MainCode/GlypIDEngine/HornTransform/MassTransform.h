...
namespace Engine
{
	namespace HornTransform
	{
		...
		public:
			...
			bool FindPrecursorTransform(PeakProcessing::PeakData &pk_data, double parent_mz, std::vector<IsotopeFitRecord> *transform_record, double background_intensity, double min_peptide_intensity) ; 
