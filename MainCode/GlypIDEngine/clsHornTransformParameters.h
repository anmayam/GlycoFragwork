...
namespace GlypID
{
	namespace HornTransform
	{
		...
		public __gc class clsHornTransformParameters: public System::ICloneable
		{
			...
			GlypID::clsElementIsotopes *mobjElementIsotopes ; 
			int mint_min_scan ; 
			int mint_max_scan ; 
		...
		public:
			...
			~clsHornTransformParameters(void);
			void SaveHornTransformParameters(System::Xml::XmlTextWriter *xwriter) ; 
			void SaveMiscellaneousParameters(System::Xml::XmlTextWriter *xwriter) ; 

			void LoadHornTransformParameters(System::Xml::XmlReader *rdr) ; 
			void LoadMiscellaneousParameters(System::Xml::XmlReader *rdr) ; 
			...
			virtual Object* Clone()
			{
				...
				new_params->set_ElementIsotopeComposition(static_cast<GlypID::clsElementIsotopes*>(this->get_ElementIsotopeComposition()->Clone())) ; 
